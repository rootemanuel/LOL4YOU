...
class perfilstatsTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                //Icon Image
                let cell = Bundle.main.loadNibNamed("perfilstatsimageTVCC", owner: self, options: nil)?.first as! perfilstatsimageTVCC
                
                if let imgperfil = UIImage(named:"profile_icon_\(rootclass.Summoner.profileIconId)") {
                    cell.imgperfil.image = imgperfil
                    cell.imgperfil.layer.borderWidth = 4
                    cell.imgperfil.layer.borderColor = UIColor(hex: rootclass.colors.BORDA_BRILHANTE.rawValue).cgColor
                }
                
                return cell
            default:
                let cell = Bundle.main.loadNibNamed("perfilstatsinfoTVCC", owner: self, options: nil)?.first as! perfilstatsinfoTVCC
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let cell = self.tableView.dequeueReusableHeaderFooterView(withIdentifier: "hperfilstatsTVH")
        let cheader = cell as! hperfilstatsTVH
    ...
    func initView(){
        ...
        let nib = UINib(nibName: "hperfilstatsTVH", bundle: nil)
        tableView.register(nib, forHeaderFooterViewReuseIdentifier: "hperfilstatsTVH")
